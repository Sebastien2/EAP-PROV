...
{
	wpa_printf(MSG_INFO, "\033[0;33m EAP-MSCHAPV2 \033[0m challenge reply");
	...
	wpa_printf(MSG_INFO, "PERSO: testing in mschapv2\n\n\n");
	if (data->peer_challenge) {
		wpa_printf(MSG_INFO, "PERSO: testing part 1 in mschapv2\n\n\n");
		...
		wpabuf_free(resp);
		wpa_printf(MSG_INFO, "PERSO: testing part 2 in mschapv2\n\n\n");
		return NULL;
	}
	else
	{
		wpa_printf(MSG_INFO, "PERSO: testing part 3 in mschapv2\n\n\n");
...
{
	wpa_printf(MSG_INFO, "\033[0;33m EAP-MSCHAPV2 \033[0m challenge");
					    ...
					    size_t req_len, u8 id)
{
	...
	wpa_hexdump_ascii(MSG_DEBUG, "EAP-MSCHAPV2: Success message",
			  pos, len);
	wpa_printf(MSG_DEBUG, "EAP-MSCHAPV2: Authentication succeeded");
