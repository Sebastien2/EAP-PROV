...
#ifdef EAP_PROV
	if (ret == 0)
	//wpa_printf(MSG_INFO, "EAP-PROV registered");
		ret = eap_peer_prov_register();
#endif /* end of personal addition EAP_PROV */

/* personal addition */
#ifdef EAP_OUT
	if (ret == 0)
	//wpa_printf(MSG_INFO, "EAP-OUT registered");
		ret = eap_peer_out_register();
#endif /* end of personal addition EAP_OUT */

/* personal addition */
#ifdef EAP_TEST
	if (ret == 0)
	//wpa_printf(MSG_INFO, "EAP-TEST registered");
		ret = eap_peer_test_register();
#endif /* end of personal addition EAP_TEST */
