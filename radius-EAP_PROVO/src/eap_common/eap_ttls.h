...
/* 
 * The message ID for configuration message 
 * that is used for configuring a peer or provisioning credentials 
 */
#define EAP_TTLS_CONFIG_MESSAGE 192
#define RADIUS_VENDOR_ID_HUAWEI 199
