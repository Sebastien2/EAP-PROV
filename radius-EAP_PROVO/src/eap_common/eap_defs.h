...
enum eap_type {
	...
	EAP_TYPE_PROV=200 /* personal addition */,
	EAP_TYPE_OUT=201 /* personal addition */,
	EAP_TYPE_TEST=202 /* personal addition */
};
...
enum {
	...
	EAP_VENDOR_HOSTAP = 39068 /* hostapd/wpa_supplicant project =0x989c */,
