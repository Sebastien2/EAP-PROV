...
static void * eap_peap_init(struct eap_sm *sm)
{
	...
	//TODO PERSO: remove the following line
						 ...
						 u8 id)
{
	...
	if (data->peap_version == 0 && data->tlv_request == TLV_REQ_SUCCESS &&
	    data->crypto_binding != NO_BINDING) {
			wpa_printf(MSG_INFO, "\n\n\n PERSO: setting crypto_binding sent \n\n\n");
		u8 *mac;
					...
					struct wpabuf *in_data)
{
	...
	wpa_printf(MSG_INFO, "\n\n\n PERSO: setting crypto_binding_used\n\n\n");
